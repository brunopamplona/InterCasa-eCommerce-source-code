              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($reason['reason_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $reason['name']; ?></td>
                  <td class="text-right"><?php foreach ($reason['stores'] as $store) { echo $stores[$store]['name'] . '<br />'; } ?></td>
				  <td class="text-right"><?php echo $reason['status']; ?></td>
                  <td class="text-right"><a href="<?php echo $reason['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=product_review/report/reason&token=<?php echo $token; ?>';
