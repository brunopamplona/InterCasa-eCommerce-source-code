...
<div class="heading">
<h1><img src="view/image/payment.png" alt="" /> GerenciaNET Transparente [Loja5]</h1>
...
<a href="#configuracoes" class="selected" style="display: inline;">Configura&ccedil;&otilde;es</a>
<a href="#cartao" style="display: inline;">Cart&atilde;o</a>
<a href="#boleto" style="display: inline;">Boleto</a>
<a href="#carne" style="display: inline;">Carn&ecirc;</a>
<a href="#status" style="display: inline;">Status</a>
<a href="#sobre" style="display: inline;">Sobre</a>
</div>
...
<tr>
<td width="250">Serial</td>
<td><input class="form-control-pagseguro" type="text" size="40" name="gn5_serial" value="<?php echo $gn5_serial; ?>" /></td>
</tr>
<tr>
<td>Status Licen&ccedil;a:</td>
<td><?php echo ($mod_ativado==1)?'M&oacute;dulo ativado':'Problema na ativa&ccedil;&atilde;o do m&oacute;dulo';?></td>
</tr>
<tr>
<td>Status</td>
<td><select class="form-control-pagseguro" name="gn5_status">
<?php if ($gn5_status) { ?>
...
<tr>
<td>Ambiente</td>
<td><select class="form-control-pagseguro" name="gn5_modo">
<?php if ($gn5_modo) { ?>
...
<td><input class="form-control-pagseguro" type="text" size="40" name="gn5_conta" value="<?php echo $gn5_conta; ?>" /></td>
</tr>
<tr>
<td>Cliente ID</td>
<td><input class="form-control-pagseguro" type="text" size="40" name="gn5_id" value="<?php echo $gn5_id; ?>" /></td>
</tr>
<tr>
<td>Cliente Secret</td>
<td><input class="form-control-pagseguro" type="text" size="40" name="gn5_sec" value="<?php echo $gn5_sec; ?>" /></td>
</tr>
<tr>
<td>Origem CPF (cobran&ccedil;a)</td>
<td>
<select class="form-control-pagseguro" name="gn5_fiscal">
<option value="">Digitar manual</option>
<?php foreach ($colunas as $k=>$v) { ?>
<?php if ($v['Field'] == $gn5_fiscal) { ?>
<option value="<?php echo $v['Field']; ?>" selected="selected"><?php echo $v['Field']; ?></option>
<?php } else { ?>
<option value="<?php echo $v['Field']; ?>"><?php echo $v['Field']; ?></option>
<?php } ?>
<?php } ?>
</select>
</td>
...
<tr>
<td>Origem N&uacute;mero (cobran&ccedil;a)</td>
<td>
<select class="form-control-pagseguro" name="gn5_numero">
<option value="">Vai junto ao logradouro</option>
<?php foreach ($colunas as $k=>$v) { ?>
<?php if ($v['Field'] == $gn5_numero) { ?>
<option value="<?php echo $v['Field']; ?>" selected="selected"><?php echo $v['Field']; ?></option>
<?php } else { ?>
<option value="<?php echo $v['Field']; ?>"><?php echo $v['Field']; ?></option>
<?php } ?>
...
<td>Zona</td>
<td>
<select class="form-control-pagseguro" name="gn5_geo_zone_id">
<option value="0">Todas</option>
<?php foreach ($geo_zones as $geo_zone) { ?>
<?php if ($geo_zone['geo_zone_id'] == $gn5_geo_zone_id) { ?>
...
<tr>
<td>Total minimo</td>
<td><input class="form-control-pagseguro dinheiro" type="text" name="gn5_total" size="3" value="<?php echo $gn5_total; ?>" /></td>
</tr>
</table>
</div>
...
<table class="table table-condensed">
<tr>
<td>Ativar Cart&atilde;o</td>
<td><select class="form-control-pagseguro" name="gn5_cartao">
<?php if ($gn5_cartao) { ?>
<option value="1" selected="selected">SIM</option>
<option value="0">NAO</option>
<?php } else { ?>
<option value="1">SIM</option>
<option value="0" selected="selected">NAO</option>
<?php } ?>
</select></td>
</tr>
<tr>
<td width="250">Titulo</td>
<td><input type="text" class="form-control-pagseguro" size="40" name="gn5_titulo" value="<?php echo $gn5_titulo; ?>" /></td>
</tr>
<tr>
<td>Ordem</td>
<td><input class="form-control-pagseguro" type="text" name="gn5_sort_order" value="<?php echo $gn5_sort_order; ?>" size="3" /></td>
</tr>
</table>
</div>
...
<tr>
<td>Ativar Boleto</td>
<td><select class="form-control-pagseguro" name="gn5_boleto">
<?php if ($gn5_boleto) { ?>
<option value="1" selected="selected">SIM</option>
<option value="0">NAO</option>
<?php } else { ?>
...
<tr>
<td width="250">Titulo</td>
<td><input type="text" class="form-control-pagseguro" size="40" name="gn5_titulo_boleto" value="<?php echo $gn5_titulo_boleto; ?>" /></td>
</tr>
<tr>
<td>Ordem</td>
<td><input class="form-control-pagseguro" type="text" name="gn5_sort_order_boleto" value="<?php echo $gn5_sort_order_boleto; ?>" size="3" /></td>
</tr>
</table>
</div>

<div role="tabpanel" class="tab-pane" id="carne">
<table class="table table-condensed">
<tr>
<td>Ativar Carn&ecirc;</td>
<td><select class="form-control-pagseguro" name="gn5_carne">
<?php if ($gn5_carne) { ?>
<option value="1" selected="selected">SIM</option>
<option value="0">NAO</option>
<?php } else { ?>
...
<tr>
<td width="250">Titulo</td>
<td><input type="text" class="form-control-pagseguro" size="40" name="gn5_titulo_carne" value="<?php echo $gn5_titulo_carne; ?>" /></td>
</tr>
<tr>
<td>Dividir o Total</td>
<td><select class="form-control-pagseguro" name="gn5_carne_dividir_valor">
<?php if ($gn5_carne_dividir_valor) { ?>
<option value="1" selected="selected">SIM</option>
<option value="0">NAO</option>
<?php } else { ?>
<option value="1">SIM</option>
...
<tr>
<td>Dias ao Primeiro Vencimento</td>
<td><input class="form-control-pagseguro" type="text" name="gn5_carne_primeiro" value="<?php echo $gn5_carne_primeiro; ?>" size="3" /></td>
</tr>
<tr>
<td>Fatura Minima (se dividir)</td>
<td><input class="form-control-pagseguro" type="text" name="gn5_carne_minimo" value="<?php echo $gn5_carne_minimo; ?>" size="3" /></td>
</tr>
<tr>
<td>Qtd Maxima de Meses a Faturar</td>
<td><input class="form-control-pagseguro" type="text" name="gn5_carne_div" value="<?php echo $gn5_carne_div; ?>" size="3" /></td>
</tr>
<tr>
<td>Ordem</td>
<td><input class="form-control-pagseguro" type="text" name="gn5_sort_order_carne" value="<?php echo $gn5_sort_order_carne; ?>" size="3" /></td>
</tr>
</table>
</div>
...
<td><select class="form-control-pagseguro" name="gn5_in">
<?php foreach ($order_statuses as $order_status) { ?>
<?php if ($order_status['order_status_id'] == $gn5_in) { ?>
...
<tr>
<td>Status Pago</td>
<td><select class="form-control-pagseguro" name="gn5_pg">
<?php foreach ($order_statuses as $order_status) { ?>
<?php if ($order_status['order_status_id'] == $gn5_pg) { ?>
<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
<?php } else { ?>
<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
<?php } ?>
...
<tr>
<td>Status N&atilde;o Pago</td>
<td><select class="form-control-pagseguro" name="gn5_ne">
<?php foreach ($order_statuses as $order_status) { ?>
<?php if ($order_status['order_status_id'] == $gn5_ne) { ?>
<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
<?php } else { ?>
<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
<?php } ?>
...
<td><select class="form-control-pagseguro" name="gn5_ca">
<?php foreach ($order_statuses as $order_status) { ?>
<?php if ($order_status['order_status_id'] == $gn5_ca) { ?>
<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
<?php } else { ?>
<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
<?php } ?>
...
<td><select class="form-control-pagseguro" name="gn5_de">
<?php foreach ($order_statuses as $order_status) { ?>
<?php if ($order_status['order_status_id'] == $gn5_de) { ?>
<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
<?php } else { ?>
<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
<?php } ?>
...
<tr>
<td>Status Em Disputa/Changeback</td>
<td><select class="form-control-pagseguro" name="gn5_di">
<?php foreach ($order_statuses as $order_status) { ?>
<?php if ($order_status['order_status_id'] == $gn5_di) { ?>
<option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
<?php } else { ?>
<option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
<?php } ?>
...
<td style="line-height: 20px !important;width:70%" valign="top">
<iframe src="https://www.loja5.com.br/novidades.php" width="100%" height="400" frameBorder="0">N&atilde;o aceita iframes.</iframe>
</td>
</tr>
</table>
</div>
