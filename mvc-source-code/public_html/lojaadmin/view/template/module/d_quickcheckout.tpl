...
<div id="content">
	...
	<div  >
		<div class="container-fluid">
				...
				<a type="submit" id="button_save" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></a>
		 	...
		 	<form action="<?php echo html_entity_decode($action); ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
									...
									<div class="col-sm-10">
										<div class="tab-content">
											...
											<div id="d_home" class="tab-pane active">
									            <div >
									                <h3 class="page-header"><span class="fa fa-home"></span> <span><?php echo $text_home; ?></span></h3>
									            </div>
									            <?php if(!$settings){ ?>
									            ...
									            <div class="row">
									                ...
									                <div id="setting_id_<?php echo $setting_value['setting_id']; ?>" class="col-lg-3 col-md-4 col-sm-6 ">
														<div class="tile  <?php echo ($setting_value['setting_id'] == $setting_id) ? 'selected' : ''; ?>">
															<a href="#" class="view_setting " data-setting-id="<?php echo $setting_value['setting_id']; ?>" >
                 ...
                 <h3 class="pull-right" data-toggle="tooltip" title="<?php echo $help_average_rating; ?>"><?php echo round($setting_value['average_rating'] * 100); ?>%</h3>
											...
											<div id="d_confirm" class="tab-pane">
												...
												<h3 class="page-header">
													<span class="fa fa-shopping-cart fa-fw"></span> <span><?php echo $text_cart; ?> &
...
$('[data-toggle="tooltip"]').tooltip()
  ...
  $(".table-sortable").sortable({
	...
	$('body').on('change', '#select_config', function(){
		...
		var config = $(this).val();
		$('body').append('<form action="<?php echo html_entity_decode($action); ?>" id="config_update" method="post" style="display:none;"><input type="text" name="config" value="' + config + '" /></form>');
	...
	$('body').on('click', '.view_setting', function(){ 
