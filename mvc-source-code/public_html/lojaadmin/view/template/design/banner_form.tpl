<?php echo $header; ?>
                    ...
                    <table id="images" class="list">
                        ...
                        <?php foreach ($banner_images as $banner_image) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php foreach ($languages as $language) { ?>
                                        <textarea style="width:600px; height:250px;"
                                                  ...
                                                  id="description"><?php echo isset($banner_image['description'][$language['language_id']]) ? $banner_image['description'][$language['language_id']]['description'] : ''; ?></textarea>
                                        <img src="view/image/flags/<?php echo $language['image']; ?>"
                                             title="<?php echo $language['name']; ?>"/><br/>
                                    <?php } ?>
                                </td>
                                ...
                                <td class="left">
                                    <div class="image"><img src="<?php echo $banner_image['thumb']; ?>" alt=""
                                                            id="thumb<?php echo $image_row; ?>"/>
                                        <input type="hidden" name="banner_image[<?php echo $image_row; ?>][image]"
                                ...
                                <td>
                                    <input type="hidden" name="banner_image[<?php echo $image_row; ?>][banner_image_id]"
                                           value="<?php echo $banner_image['banner_image_id']; ?>"/>
                                        ...
                                        <?php foreach ($categories as $category) { ?>
                                            ...
                                            <div class="<?php echo $class; ?>">
                                                <?php if (in_array($category['category_id'], $banner_category[$banner_image['banner_image_id']])) { ?>
                                                    <input type="checkbox"
                                                           name="product_category[<?php echo $image_row; ?>][]"
                                    ...
                                    <a onclick="$(this).parent().find(':checkbox').attr('checked', true);">Select
                                        All</a> / <a
                                        onclick="$(this).parent().find(':checkbox').attr('checked', false);">Unselect
                                        All</a>
                                </td>
                        ...
                        <tr>
                            <td colspan="3"></td>
                            <td class="left"><span id='addbt' <?php if ($image_row >= 5) {
                                    echo ' style="display:none" ';
                                } ?> ><a onclick="addImage();"
                                         class="button"><?php echo $button_add_banner; ?></a></span></td>
                        </tr>
                        </tfoot>
                    </table>
                </form>
    ...
    <script type="text/javascript"><!--
        ...
        function addImage() {
            ...
            html += '<td class="left">';
            <?php foreach ($languages as $language) { ?>
            html += '<textarea style="width:600px; height:250px;" name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][description]" id="description"></textarea><br />';
            <?php } ?>
            html += '</td>';
