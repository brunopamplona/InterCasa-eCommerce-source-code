      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php echo $column_product_list; ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($combo['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $combo['name']; ?></td>
              <td class="left">
				<ul>
              ...
              <td class="left"><?php echo $combo['status']; ?></td>
              <td class="right"><?php foreach ($combo['action'] as $action) { ?>
...
function filter() {
	url = 'index.php?route=catalog/combo&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/combo/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
