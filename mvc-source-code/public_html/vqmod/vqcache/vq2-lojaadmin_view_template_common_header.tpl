    ...
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <?php if ($objConfig->get('product_reviews_status')) { ?><?php } else { ?><li><a href="<?php echo $review; ?>"><?php echo $text_review; ?></a></li><?php } ?>
          <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>

				<li><a href="<?php echo $pq_link_questions; ?>"><?php echo $pq_questions; ?></a></li>
			
<li><a href="<?php echo $combo; ?>"><?php echo $text_combo_title; ?></a></li>
        </ul>
      </li>
