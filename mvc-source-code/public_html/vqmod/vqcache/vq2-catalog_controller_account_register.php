...
class ControllerAccountRegister extends Controller {
	private $error = array();
  	...
  	protected function validate() {
	   ...
	   if ((utf8_strlen($this->request->post['fax']) < 10) || (utf8_strlen($this->request->post['fax']) > 32)) {
		   $this->error['fax'] = $this->language->get('error_fax');
	   }

	   if ((utf8_strlen($this->request->post['tax_id']) < 11) || (utf8_strlen($this->request->post['tax_id']) > 14)) {
    	...
    	if (!$this->error) {
			...
			{
				$data = array('erros' => false, 'success' => false);
				$cep = $this->request->get['cep'];
				$url = "http://ws.comerciobr.com/Api/cep.json?cep={$cep}&apiKey=9106340a33a2407d63d22e6275300d33";
				$ch = curl_init($url);
