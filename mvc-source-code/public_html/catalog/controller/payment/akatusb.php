...
class ControllerPaymentAkatusb extends Controller 
{
  ...
  public function confirm() {
		...
		$fee_discont = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_total` WHERE code = 'pc_fee_discount' AND order_id = '".$order_id."'");
        ...
        $temFeeDesconto = (count($fee_discont->rows)) ? true : false;
