		...
		<div class="box-product box-subcat">
			<ul class="row"><?php $i=0;?>
				...
				<li class="cat-height  span2">
					...
					<?php } ?>
					<div class="name subcatname"><h2><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></h2></div>
				</li>
				<?php } ?>
			</ul>
		</div>
	...
	<ul class="row">
	  ...
	  <?php } ?>
		...
		<div class="description"><?php echo $product['description']; ?></div>
			...
			<?php if ($product['price']) { ?>
				<div class="price">
					...
					<?php } else { ?><span class="price-old">De <?php echo $product['price']; ?></span> <br/>
		...
		<div class="rating">
			...
			<img height="8" src="catalog/view/theme/theme255/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
			<?php } ?>
		</div>
	</li>
		<?php } ?>
...
<h2 style="padding-left: 3%;"><?php echo $heading_title; ?></h2>

<div class="row"  style=" padding-left: 5%;" >
<div class="tabs">
  <div class="tab-heading" onclick="MostrarTexto('Texto')" >
   Clique para saber mais detalhes  </div></div>
...
function display(view) {
	if (view == 'list') {
		...
		$('.product-list ul li').removeClass('span4');
		...
		$('.product-grid ul li').addClass('span4');
