    ...
    <div class="row">
        ...
        <div class="span12">
            ...
            <div class="cont-top">
                    ...
                    <div class="box-cont">
                        <div class="box-top-tel"><span> <i class="fa fa-phone-square"></i> (21) 3298-7945 | (21) 99255-1471</span></div>
                    </div>
                   
                    
                <div class="box-cont">
            <div class="logo"><img width="164" height="98" src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/image/inter-logo-topo.jpg"></div>
            </div>
            
            <div class="box-cont">
            <div class="box-phone">
                
                <span><i class="fa fa-phone-square"></i> (21) 3298-7945 | (21) 99255-1471</span>
        ...
        <div class="span12">
			...
			<div class="box-icons-menu">
			    ...
			    <div class="btn-blue"><i class="fa fa-shopping-cart"></i></div>
			    <div class="btn-blue"><i class="fa fa-search"></i></div>
			</div>
				...
				<ul>
                  ...
                  <li style="float:right;" class="two">
                   ...
                   <div class="mega-menu-search fadeIn animated">
                       <div class="row">
                           <div class="container">
                               <form action="https://intercasamoveis.com.br/?route=product/search?" method="get">
                  ...
                  <li style="float:right;"><a href="http://blog.intercasamoveis.com.br/"><i class="fa fa-wordpress"></i> Blog</a></li>
                  <li style="float:right;">
                      <a href="https://intercasamoveis.com.br/index.php?route=checkout/checkout"><i class="fa fa-shopping-cart"></i> Checkout</a>
                      
                  </li>
                  
                  <li style="float:right;">
                      <a href="https://intercasamoveis.com.br/index.php?route=account/login"><i class="fa fa-user"></i> Minha conta</a>
...
<div class="top-info-bar">
    ...
    <div class="ico-box">
      ...
      <div class="box-right">
          <h3>MONTAGEM GRÁTIS*</h3>
          <small>RJ e SP CAPITAL</small>
      </div>
      ...
      <div class="box-right">
          <h3>ORÇAMENTOS</h3>
          <small>contato@intercasamoveis.com.br</small>
      </div>
    ...
    <div class="ico-box">
      ...
      <div class="box-right">
          <h3>CRIE SEU QUARTO</h3>
          <small>INFANTIL/BEBE</small>
      </div>
...
<div class="container">
			...
			<nav class="menu">
				...
				<ul>
                    ...
                    <li><a href="http://site.intercasamoveis.com.br">Site Institucional</a></li>
                 ...
                 <li style="float:right;" class="two">
                  ...
                  <li><a href="http://blog.intercasamoveis.com.br/"><i class="fa fa-wordpress"></i> Blog</a></li>
