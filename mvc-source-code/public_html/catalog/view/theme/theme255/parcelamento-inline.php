...
echo '<div class="percela inline"> ' . $qtd_parcelas . 'x de <b>' . $moeda_da_loja . number_format($valor_parcela, 2, ',', '.');
if ($juros == 0) { echo '</b> sem juros</div>'; } else { echo '<br /><p>com juros de ' . $juros . '% ao m&ecirc;s</div>'; }
}
?>