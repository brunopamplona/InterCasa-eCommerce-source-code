...
<div id="content">
  ...
  <div id="responsivo">
    ...
    <?php } ?>
    <?php if ($falhou) { ?>
    <div class="alert alert-warning"><?php echo $error_autorizacao; ?></div>
    <?php } ?>
...
<script type="text/javascript"><!--
  ...
  function bandeiras() {
    $.ajax({
      url: 'index.php?route=payment/cielo_api_debito/bandeiras',
      dataType: 'json',
      cache: false,
      beforeSend: function() {
  ...
  function transacao(campo) {
    $.ajax({
      url: 'index.php?route=payment/cielo_api_debito/setTransacao',
      type: 'post',
