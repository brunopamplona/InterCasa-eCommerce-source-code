...
<script type="text/javascript"><!--
  ...
  function parcelas(bandeira) {
    ...
    $.ajax({
      url: 'index.php?route=payment/cielo_api_credito/parcelas&bandeira=' + bandeira,
      dataType: 'json',
      cache: false,
      beforeSend: function() {
  ...
  function bandeiras() {
    $.ajax({
      url: 'index.php?route=payment/cielo_api_credito/bandeiras',
      dataType: 'json',
      cache: false,
      beforeSend: function() {
        $('#button-confirm').attr('disabled', true);
  ...
  function transacao(campo) {
    ...
    <?php } ?>
    $.ajax({
      url: 'index.php?route=payment/cielo_api_credito/setTransacao',
      type: 'post',
